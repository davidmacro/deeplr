...
#     Date: 2024-07-05
#  Purpose: Refactored using function factories
# ----------------------------------------------------------
# 
#  
ff_pimp <- function(.f){
    ...
    return(
        function(text, source_lang, help_lang, auth_key = "your_key") {
        
          # Translate to helper language
          text2 <- .f(text = text, target_lang = help_lang, source_lang = source_lang, auth_key = auth_key)
        
          # Translate back into source language
          pimped <- .f(text = text2, target_lang = source_lang, source_lang = help_lang, auth_key = auth_key)
